...
export const highestGrossingFranchises: GameList = {
  ...
  items: [
    ...
    "Thor", "Inside Out", "Guardians of the Galaxy", "Godzilla", "Iron Man",
    "Star Trek", "Kung Fu Panda", "Madagascar", "Indiana Jones", "Captain America",
    "How to Train Your Dragon", "Black Panther", "Terminator", "The Conjuring Universe", "Planet of the Apes",
    "Jumanji", "MonsterVerse", "Finding Nemo", "Men in Black", "Rocky",
    "The Incredibles", "The Matrix", "Cars", "Bourne", "Aladdin",
  ],
  values: [
    ...
    "$2.7B", "$2.5B", "$2.5B", "$2.5B", "$2.4B",
    "$2.3B", "$2.3B", "$2.3B", "$2.2B", "$2.2B",
