...
export const directorsBoxOffice: GameList = {
  ...
  items: [
    ...
    "David Yates", "Christopher Nolan", "Jon Favreau", "James Wan", "Ridley Scott",
    "Tim Burton", "Ron Howard", "Robert Zemeckis", "Gore Verbinski", "Bryan Singer",
    "Zack Snyder", "Joss Whedon", "Sam Raimi", "Taika Waititi", "Ryan Coogler",
  ...
  values: [
    ...
    "$6.0B", "$5.8B", "$5.5B", "$5.4B", "$5.0B",
    "$4.9B", "$4.6B", "$4.4B", "$4.2B", "$4.0B",
    "$3.9B", "$3.8B", "$3.8B", "$3.7B", "$3.6B",
