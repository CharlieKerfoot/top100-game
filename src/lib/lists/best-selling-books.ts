...
export const bestSellingBooks: GameList = {
  ...
  items: [
    ...
    "Harry Potter and the Half-Blood Prince", "Harry Potter and the Deathly Hallows", "The Bridges of Madison County", "One Hundred Years of Solitude", "Lolita",
    "Heidi", "The Common Sense Book of Baby and Child Care", "Anne of Green Gables", "Black Beauty", "The Name of the Rose",
    "The Eagle Has Landed", "Watership Down", "The Hite Report", "Charlotte's Web", "The Ginger Man",
    "The Purpose Driven Life", "The Tale of Peter Rabbit", "Jonathan Livingston Seagull", "The Very Hungry Caterpillar", "Sophie's World",
    "A Message to Garcia", "To Kill a Mockingbird", "Flowers in the Attic", "Angels & Demons", "War and Peace",
    "Cosmos", "How to Win Friends and Influence People", "Alcoholics Anonymous", "The Adventures of Pinocchio", "The Diary of a Young Girl",
    "Kane and Abel", "Fear of Flying", "How the Steel Was Tempered", "Your Erroneous Zones", "The Thorn Birds",
