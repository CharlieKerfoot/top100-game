// Top 100 most common US surnames plus ~400 additional common surnames
// Source: US Census Bureau 2010 Census Surname Data (Names_2010Census.csv)
export const usSurnamesHints: string[] = [
  // Top 100 (ranks 1-100)
  ...
  "Terry", "Hale", "Leon", "Benson", "Haynes",
  "Horton", "Miles", "Lyons", "Pham", "Graves",
  "Bush", "Thornton", "Wolfe", "Warner", "Cabrera",
  "Mckinney", "Mann", "Zimmerman", "Dawson", "Lara",
  "Fletcher", "Page", "Mccarthy", "Love", "Robles",
  "Cervantes", "Solis", "Erickson", "Reeves", "Chang",
  "Klein", "Salinas", "Fuentes", "Baldwin", "Daniel",
  "Simon", "Velasquez", "Hardy", "Higgins",
  // Ranks 401-500
  ...
  "Franco", "Saunders", "Rowe", "Gallagher", "Farmer",
